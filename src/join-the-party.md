...
In an upcoming lesson, we'll explore some of these tricks of the trade to speed up common geospatial operations. Quickly moving through the real world may require a jet engine, but that doesn't mean that your laptop needs to sound like one. If you'd like to be notified when it's up, [send us a note](./contact), or subscribe to our [rss feed](rss.xml).
